...
const Footer = () => {
  return (
    <div>
      <section className=" mx-auto py-10 bg-base-200">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-10 lg:px-16 mt-10">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div className="col-span-2 md:col-span-4 xl:pr-8">
              <Logo></Logo>

              <p className="text-base leading-relaxed text-gray-600 mt-7">
                Savor the Flavor. Explore a world of culinary delights at Foodie
                Feast, where every dish tells a story. Come hungry, leave happy
              </p>

              <a
                href="#"
                title=""
                className="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-red-600 rounded-md hover:bg-red-700 focus:bg-red-700 mt-7"
              >
                <svg
                  className="w-6 h-6"
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <p className="text-sm text-gray-600">
              © Copyright 2023, All Rights Reserved by FoodieFeast
            </p>
