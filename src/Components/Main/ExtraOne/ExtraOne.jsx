        ...
        <div className="max-w-screen-2xl mx-auto px-6 md:px-10 lg:px-16">
          <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
            <div className="flex flex-col justify-between lg:py-5">
              <h2 className="text-4xl font-bold leading-tight lg:leading-tight lg:text-6xl">
                <span className="text-amber-500">Foodie Feast</span> Membership
                Benefits
              </h2>
              ...
              <div className="mt-auto">
                ...
                <blockquote className="mt-6">
                  <p className="text-lg leading-relaxed ">
                    Being a Muslim, I appreciate the thoughtful consideration
                    that Foodie Feast provides in their menu. Their diverse
                    range of halal options means I can enjoy scrumptious meals
                    without compromising on my dietary restrictions. The
                    membership benefits, including discounts and exclusive
                    offers, make dining here even more enjoyable. I highly
                    recommend Foodie Feast to fellow Muslims seeking a
                ...
                <div className="flex items-center mt-8">
                  ...
                  />
                  <div className="ml-4">
                    <p className="text-base font-semibold ">Ahmed Khan</p>
                    <p className="mt-px text-sm text-gray-400">Engineer</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="">
              <div className="overflow-hidden bg-gray-200 rounded-md">
                <div className="p-10">
                  ...
                  <p className="mt-4 text-6xl font-bold text-black">$89</p>
